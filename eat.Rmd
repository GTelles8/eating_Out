...
#Introduction
To answer the research question we look at the variable types.

#Methods
Both variables are categorical, use cat~cat helper file, barchart and chi squared test, and fisher exact.
